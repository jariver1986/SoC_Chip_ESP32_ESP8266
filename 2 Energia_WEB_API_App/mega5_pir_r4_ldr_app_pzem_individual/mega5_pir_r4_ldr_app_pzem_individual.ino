...
void loop() 
{
  ...
  if(muestra>=3 && muestra<6)
  {
    ...
    lcd.setCursor(0, 1);lcd.print("Volt[v]= "+String(voltage,2));
    lcd.setCursor(0, 2);lcd.print("I[A]  = "+String(current,2));
  }
  ...
  if (Serial1.available() > 0)
  {
     ...
     if(dato1=='9')
     {
      ...
      r4=1;
      trabaja=2;
      cent1=1;cent2=1;cent3=1;cent4=1;
     }
     if(dato1=='A')
     {
      digitalWrite(22,HIGH);
      ...
      r3=0;
      r4=0;
      cent1=0;cent2=0;cent3=0;cent4=0;;
     }
     dato1=0;
     //Cuando todas las luces sean apagadas desde la app vuelve a su estado original
     if((cent1==0)&&(cent2==0)&&(cent3==0)&&(cent4==0))
     {
         trabaja=0;
     }
  }
  ...
  if(trabaja==1)
  {
    //se enciende lampara1 por ser menor a 25
    if(luz<=25) 
    {
      digitalWrite(22,LOW);
      estado1="encendido";
    ...
    //se enciende lampara3 por ser menor a 25
    if(luz2<=25) 
    {
      digitalWrite(24,LOW);
      estado3="encendido";
    ...
    //se enciende lampara4 por ser menor a 25
    if(luz3<=25) 
    {
      digitalWrite(25,LOW);
      estado4="encendido";
